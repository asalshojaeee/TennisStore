          ...
          loading ? (
            ...
            (
              products.map((pro, index) => {
                return (
                  <div key={index} className='cart-body cursor-pointer h-full w-full flex-col  shadow-sm p-5 rounded-xl'>
                    <img

                      src={pro.productImage[currentImage[pro._id] || 0]}

                      alt="" className='bg-transparent mix-blend-multiply h-56 rounded-xl hover:scale-120 transition-all object-contain w-full' />
                    <div className="flex justify-center gap-2 mt-3">
